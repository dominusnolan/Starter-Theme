...
Plugin Name: Starter Recent Posts Widget

Plugin URI: http://vuckovic.biz/wordpress-plugins/tw-recent-posts-widget

Description: Starter Recent Posts Widget is advanced version of the WordPress Recent Posts widget allowing increased customization to display recent posts from category you define.
...
class TW_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$this->WP_Widget ( 'tw-recent-posts', __ ( 'Starter Recent Posts ', $this->localizationDomain ), $widget_ops );
...
while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
	...
	<?php if ($show_post_thumb && has_post_thumbnail()) { ?>
		...
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( array( $width, $height ) , array( 'title' => '' ) ); ?></a>
